...
/* harmony export */   "default": () => (/* binding */ bindTabs)
/* harmony export */ });
function bindTabs(containerSelector, triggerSelector, contentSelector) {
  let isInline = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  let triggerActiveClass = arguments.length > 4 ? arguments[4] : undefined;
  let linkActiveClass = arguments.length > 5 ? arguments[5] : undefined;
...
/* harmony export */ });
/* harmony import */ var _validateNumInputs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validateNumInputs */ "./src/js/modules/validateNumInputs.js");
...
function calculator() {
  ...
  restoreProgress();
  (0,_validateNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])(widthInput[0], heightInput[0]);
  ...
  function bindActions(elements, key) {
...
function createModal(triggerSelector, modalSelector, closeSelector) {
  let closeOnOverlayClick = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  function bindModal() {
  ...
  function showModal(modal) {
    ...
    (0,_fixOverflow__WEBPACK_IMPORTED_MODULE_0__.addMargin)();
  }
...
function forms(calculatorState, resetCalculator) {
  ...
  formsList.forEach(form => {
    form.querySelectorAll('input[name="user_phone"]').forEach(input => (0,_validateNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])(input));
...
function images(containerSelector) {
  const container = document.querySelector(containerSelector);
...
/* harmony export */ });
function timer(timerSelector, deadlineString) {
...
/***/ "./src/js/modules/validateNumInputs.js":
/*!*********************************************!*\
  !*** ./src/js/modules/validateNumInputs.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ validateNumInput)
/* harmony export */ });
...
const glazingSlider = (0,tiny_slider__WEBPACK_IMPORTED_MODULE_0__.tns)({
  ...commonSettings,
...
const decorationSlider = (0,tiny_slider__WEBPACK_IMPORTED_MODULE_0__.tns)({
  ...commonSettings,
...
/* harmony import */ var _modules_createModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/createModal */ "./src/js/modules/createModal.js");
/* harmony import */ var _modules_bindTabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/bindTabs */ "./src/js/modules/bindTabs.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Modals:
  (0,_modules_createModal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_engineer_btn', '.popup_engineer', '.popup_close');
  (0,_modules_createModal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_btn', '.popup_calc', '.popup_calc_close', false);
  (0,_modules_createModal__WEBPACK_IMPORTED_MODULE_1__["default"])('.phone_link', '.popup', '.popup_close').showModalAfterTime(60000);
  (0,_modules_createModal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false);
  (0,_modules_createModal__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false);

  // Tabs:
  (0,_modules_bindTabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing', '.glazing_block:not(.tns-slide-cloned)', '.glazing_content', false, null, 'active');
  (0,_modules_bindTabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration', '.decoration_item:not(.tns-slide-cloned) > div', '.decoration_content > .row > div', false, 'after_click');
  (0,_modules_bindTabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.popup_calc_content', '.balcon_icons_img', '.big_img > img', true, 'do_image_more');
  ...
  // Forms:
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(calculatorState, resetCalculator);

  // Timer:
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2023-10-24');
